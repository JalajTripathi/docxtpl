from flask import Flask, send_file, render_template, request, make_response, redirect, url_for, Response
...
def login():
    ...
    if username in ["ashok.srivastava63@gmail.com", "admin@gmail.com", "editor@gmail.com"] and password in ['admin@123', '2022@aks', '2021@aks']:
...
def deleting_cookie():
    ...
    userCookie = request.cookies.get('userID')
    print("User ID Cookie: ", userCookie)
    return resp
